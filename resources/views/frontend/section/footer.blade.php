      ...
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          <a href="" class="logo d-flex align-items-center">
            <img src="{{asset('frontend/images/konjora.png')}}" alt="logo" class="me-2" style="height:70px;">
          </a>
          <ul class="generic-list-item pt-4">
            <li><a href="tel:+1631237884">+254 788425000</a></li>
            <li><a href="mailto:support@wbsite.com">allandevtech@gmail.com</a></li>
            <li>Nairobi, Kenya, Westlands, Waiyaki Way</li>
          </ul>
          <h3 class="fs-20 font-weight-semi-bold pt-4 pb-2">We are on</h3>
          <ul class="social-icons list-unstyled d-flex align-items-center">
            <li class="me-2">
              <a href="#" class="d-flex align-items-center justify-content-center rounded-circle bg-primary text-white"
                style="width: 38px; height: 38px;">
                <i class="la la-facebook"></i>
              </a>
            </li>
            <li class="me-2">
              <a href="#" class="d-flex align-items-center justify-content-center rounded-circle bg-info text-white"
                style="width: 38px; height: 38px;">
            ...
            <li class="me-2">
              <a href="#" class="d-flex align-items-center justify-content-center rounded-circle bg-danger text-white"
                style="width: 38px; height: 38px;">
  ...
  <div class="copyright-content py-4">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <p class="copy-desc">&copy;Allandevtech 2025 All Rights Reserved. by <a
              href="https://allandevtech.com/">allandevtech</a>
          </p>
        </div><!-- end col-lg-6 -->
        <div class="col-lg-6">
