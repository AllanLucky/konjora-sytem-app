            ...
            <div class="row align-items-center p-2">
                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        <div class="theme-picker d-flex align-items-center text-white">
                            ...
                            <button class="theme-picker-btn light-mode-btn text-white" title="Light mode">
                        ...
                        @if (!auth()->user())
                            <ul
                                ...
                                <li
                                    class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray text-white fw-bold me-4">
                                    <i class="la la-sign-in mr-1"></i><a href=""> Login</a>
                                </li>
