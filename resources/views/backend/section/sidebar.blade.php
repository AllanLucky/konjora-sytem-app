<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li class="{{ setSidebar(['admin.instructor.index', 'admin.instructor.active']) }}">
            ...
            <ul>
                <li class="{{ setSidebar(['admin.instructor.index']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>All Instructor</a>
                </li>
                <li class="{{ setSidebar(['admin.instructor.active']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>Active Instructor</a>
                </li>
            </ul>
        </li>
        ...
        <li class="{{ setSidebar(['admin.course*']) }}">
            ...
            <ul>
                <li class="{{ setSidebar(['admin.course*']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>All Courses</a>
                </li>
            </ul>
        </li>
        ...
        <li class="{{ setSidebar(['admin.order*']) }}">
            ...
            <ul>
                <li class="{{ setSidebar(['admin.order*']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>All Orders</a>
                </li>
            </ul>
        </li>
        ...
        <li
            ...
            <ul>
                ...
                <li class="{{ setSidebar(['admin.partner*']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>Manage Partner</a>
                </li>
                <li class="{{ setSidebar(['admin.site-setting*']) }}">
                    <a href=""><i class='bx bx-radio-circle'></i>Site Settings</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li><a href=""><i class='bx bx-radio-circle'></i>Mail Setting</a></li>
                <li><a href=""><i class='bx bx-radio-circle'></i>Stripe Setting</a></li>
                <li><a href=""><i class='bx bx-radio-circle'></i>Google Setting</a></li>
            </ul>
        </li>
    </ul>
    <!--end navigation-->
