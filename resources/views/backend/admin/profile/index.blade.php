                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="country" class="form-control"
                        value="{{ old('country', auth()->user()->country) }}" placeholder="Enter your country">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="experience" class="form-control"
                        ...
                        placeholder="Example: 5+ years in administration">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="job_title" class="form-control"
                        ...
                        placeholder="System Administrator, Manager">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="department" class="form-control"
                        ...
                        placeholder="IT Department, HR, Operations">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="skills" class="form-control"
                        value="{{ old('skills', auth()->user()->skills) }}" placeholder="Laravel, Management, Security">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="website" class="form-control"
                        ...
                        placeholder="https://linkedin.com/in/adminuser">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="address" class="form-control"
                        value="{{ old('address', auth()->user()->address) }}" placeholder="Enter your address">
                    </div>
                  </div>
