        ...
        <div class="card-body p-4">
          ...
          <form class="row g-3" method="post" action="{{ route('admin.slider.update', $slider->id) }}"
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="title" id="slider_title" placeholder="Enter the slider title"
            ...
            <div class="col-md-12">
              ...
              <input type="url" class="form-control" name="video_url" id="video_url"
                placeholder="Enter the YouTube video URL" value="{{ old('video_url', $slider->video_url) }}" required>


            </div>

            <div class="col-md-12">
              <iframe id="videoPreview" src="" style="margin-top: 15px; display: none; width: 50%; height: 400px;"
