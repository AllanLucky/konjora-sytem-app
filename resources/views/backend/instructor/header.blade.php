                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{ auth()->user()->photo ? asset(auth()->user()->photo) : asset('backend/assets/images/avatars/avatar-1.png') }}"
                                                 class="msg-avatar" alt="{{ auth()->user()->name }}">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="position-relative">
                                            <div class="cart-product rounded-circle bg-light">
                                                <img src="{{ asset('backend/assets/images/products/11.png') }}" alt="product image">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#"
                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    {{-- Dynamic User Image --}}
                    <img src="{{ auth()->user()->photo ? asset(auth()->user()->photo) : asset('backend/assets/images/avatars/avatar-2.png') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('instructor.settings') }}">
