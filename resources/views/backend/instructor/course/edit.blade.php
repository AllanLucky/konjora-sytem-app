                    ...
                    <form class="row g-3" method="post" action="{{ route('instructor.course.update', $course->id) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control" name="video_url" id="video_url"
                                placeholder="Enter the YouTube video URL" value="{{ old('video_url', $course->video_url) }}"
                                required>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control editor" name="prerequisites"
                                id="prerequisites"> {{ old('prerequisites', $course->prerequisites) }}</textarea>
                        </div>
