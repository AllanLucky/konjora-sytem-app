      ...
      <div class="card-body p-4">
        ...
        <form class="row g-3" method="POST" action="{{ route('instructor.course.store') }}" enctype="multipart/form-data">
          ...
          <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="course_title" placeholder="Enter the course title"
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" name="resources" placeholder="Number of Resources"
              value="{{ old('resources') }}">
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="url" class="form-control" name="video_url" id="video_url" placeholder="Enter YouTube URL"
              value="{{ old('video_url') }}">
            <iframe id="videoPreview" style="display:none; width:100%; height:400px;" frameborder="0" allowfullscreen
              class="mt-2"></iframe>
          </div>
