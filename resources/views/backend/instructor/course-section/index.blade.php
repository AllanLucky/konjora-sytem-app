...
@section('content')
  <div class="page-content">
    <!--breadcrumb-->
    @include('backend.section.breadcrumb', ['title' => 'Course', 'sub_title' => 'Sections'])
    <!--end breadcrumb-->
    <div class="row">
        ...
        <div class="card radius-10">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img src="{{ asset($course->course_image) }}" class="rounded-circle p-1 border" width="90" height="90"
                alt="...">
          ...
          <div class="card col-md-12 radius-10">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <!-- Icon -->
                  <svg style="cursor: pointer" data-bs-toggle="collapse" data-bs-target="#demo{{$data->id}}"
                ...
                <div style="display: flex; alin-items: center; gap: 10">
                  ...
                  <div>
                    ...
                    <a href="javascript:void(0)" class="btn btn-danger delete-section" data-id="{{ $data->id }}"
                ...
                @foreach ($data['lecture'] as $lecture)
                  <div style="display: flex; align-items:center; justify-content:space-between;">
                    ...
                    <div>
                      ...
                      <a href="javascript:void(0)" class="btn btn-danger delete-lecture" data-id="{{ $lecture->id }}"
                        style="margin-left: 10px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
